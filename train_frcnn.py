...
train_imgs, classes_count, class_mapping = get_data(options.train_path) # options.train_path, 'trainval'
val_imgs, _, _ = get_data(options.train_path) # options.train_path, 'test'
